...
Public Class ucrSelector
    ...
    'EnableDataOptions() is only used by ucrSelectorByDataFrameAddRemove
    'possible remove??
    ...
    Public Overridable Sub LoadList()
        ...
        'this makes refilling of the listview unnecessarily slow, especially for wide data sets
    ...
    Public Sub SetCurrentReceiver(conReceiver As ucrReceiver)
        ...
        If conReceiver Is CurrentReceiver Then
            Exit Sub
        End If
